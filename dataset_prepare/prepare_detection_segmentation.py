...
def copy_all_files(source_image_files, target_folder, ignore_black):
    ...
    for i, img in enumerate(source_image_files, 1):
        ...
        jpg_file_path = os.path.join(target_folder,'JPEGImages', str(i).zfill(8) + ".jpg")
        rgb_im.save(jpg_file_path)


        target_json_file = os.path.join(target_folder,'JSONAnnotations', str(i).zfill(8)+".json")
        ...
        target_seg_mask = os.path.join(target_folder,'PNGSegmentationMask', str(i).zfill(8)+".png")
