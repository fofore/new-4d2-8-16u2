...
from model.utils.blob import prep_im_for_blob, im_list_to_blob, prep_dl_for_blob, dl_list_to_blob
import pdb
def get_minibatch(roidb, num_classes):
  ...
  im_blob, im_scales, dl_blob = _get_image_blob(roidb, random_scale_inds)

  # blobs = {'data': im_blob}
  blobs = {'data': im_blob, 'gt_drive_line_mask': dl_blob}
