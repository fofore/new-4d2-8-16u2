...
#
#python test_net.py --dataset kiktech_2018joint-480p-147 --vis \
#       --net mobilenet  --checksession 1 --checkepoch 44 --checkpoint 36  --cuda --load_dir ./models 2>&1 |tee test_joint480p.log

# Test FPS, with no  --vis
#python test_net.py --dataset kiktech_2018joint-480p-147 \
#       --net mobilenet  --checksession 1 --checkepoch 44 --checkpoint 36  --cuda --load_dir ./models 2>&1 |tee test_joint480p.log

# Test FPS, with no  --vis
python test_net.py --dataset kiktech_2018joint-480p-147 \
       --net shufflenet  --checksession 1 --checkepoch 249 --checkpoint 219  --cuda --load_dir ./models 2>&1 |tee test_joint480p-shufflenet.log
