...
if __name__ == '__main__':
    ...
    while (num_images >= 0):
        ...
        # mask_result[id[0], id[1], :] = 0, 255, 0  #
        batch_scores = Metrics.get_score_binary(predict=y_pred_idx[np.newaxis, :, :], target=gt_png[np.newaxis, :, :], ignore=255)
        ...
        if vis and (webcam_num == -1):
            ...
            seg_mask_path = os.path.join(args.image_dir, imglist[num_images][:-4] + "_seg-mask.jpg")
            cv2.imwrite(seg_mask_path, mask_result)
